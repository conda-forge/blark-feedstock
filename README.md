...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/blark-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9290&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/blark-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `blark` can be installed with:

```
conda install blark
```

It is possible to list all of the versions of `blark` available on your platform with:
